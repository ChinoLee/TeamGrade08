package com.example.administrator.teamgrade08;
...
import com.example.administrator.teamgrade08.Login.AdminAC;
import com.example.administrator.teamgrade08.Login.NetWorkInf;
import com.example.administrator.teamgrade08.Login.UserAc;
...
public class LoginActivity extends AppCompatActivity {
    ...
    private void hlogin(){
        ...
        if(user.equalsIgnoreCase("admin")){
            ...
            intent.setClass(LoginActivity.this,AdminAC.class);
            ...
            NetWorkInf.pwd = et_pwd.getText().toString();
            Intent intent = new Intent();
            intent.setClass(LoginActivity.this,UserAc.class);
            startActivity(intent);
